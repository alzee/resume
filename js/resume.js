	...
	var resume = {
		zh: {
			...
			more: [
				...
				'常用命令都要用函数封装，函数名一个字母，no more tab ，还能 DIY 。比如写一个函数 g() 来代替 git ，不带参数就是 git status ,  g c msg 则是 git add. ; git commit -m msg ; git push，如果没有 msg 就用 placeholder , 还可以加入一些机制来阻止 push 。再比如 alias v="command vim" ; alias vim="sudo vim" 。',
			],
		},
	};
