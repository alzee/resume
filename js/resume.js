(function() {
	var resume = {
		en: {
			...
			exp_t: 'experiences',
			edu_t: 'education',
			intro: '简练、忠信、好学、求真。擅长 Linux 系统工程，目前兴趣在 web 开发。主要技术栈为 php, symfony 4, vue.js, bootstrap 4 及原生 javascript ，后端方向，可做全栈开发。具备团队组织协调能力。',
			devenv_t: 'devel env: ',
			...
			skills_t: 'skills',
			skills: [
				'LCTT ( Linux 中国翻译组) 成员，为 linux.cn 贡献过多篇翻译',
				'本地田协会员，完成多次马拉松赛事',
