	...
	var resume = {
		zh: {
			...
			about: [
				...
				{k: 'github', v: 'https://github.com/z14', fa: 'fab fa-github', link: 'https://github.com/z14', title: 'btc'},
			...
			exp_t: '工作经历',
			edu_t: '教育经历',
			intro: '擅长 Linux 系统工程，熟悉 Fedora, Debian, RedHat/CentOS, LFS 等。目前兴趣在 web 开发，主技术栈为 php, symfony 4, twig, bootstrap 4, vue.js, mustache.js 及原生 javascript ，后端方向，可做全栈，可独立开发。具备团队组织协调能力。简练、果敢、沉着、细致、好学、求真。',
			devenv_t: '开发环境: ',
